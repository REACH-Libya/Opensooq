...
print(1)
pagelink= "https://ly.opensooq.com/en/jobs/all"
#print(pagelink)
try:
...
for i in range(1,15):
        print(i)
        pagelink= "https://ly.opensooq.com/en/jobs/all?page=%s&per-page=30"%(i)
        #print(pagelink)
        try:
            page = urllib2.urlopen(pagelink).read()
            soup = BeautifulSoup(page,'html.parser')
...
with open('/home/ubuntu/reach/rentPricesMonitoring/jobs/all_offers_posts.obj', 'wb') as f:
